...
<div class="code">
	<div id="column-right">
		<a type="button" class="button button-reversed" data-toggle="modal"
			data-target="#add6">추가</a> <a href="#" class="button">수정</a> <a
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th><input type="checkbox" id='check_all6' class='input_check' /></th>
				<th>No</th>
				<th>코드명</th>
			</tr>
		</thead>
...
<!-- Modal -->
<div id="add6" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title">비정기 납입방법 추가</h3>
			</div>
