...
<div class="code">
	<div id="column-right">
		<a type="button" class="button button-reversed" data-toggle="modal"
			data-target="#add8">추가</a> <a href="#" class="button">수정</a> <a
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th><input type="checkbox" id='check_all8' class='input_check' /></th>
				<th>No</th>
				<th>코드명</th>
			</tr>
		</thead>
...
<!-- Modal -->
<div id="add8" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title">소속교회 추가</h3>
			</div>
